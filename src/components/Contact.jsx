...
const PORTAL_PREFIX = '[ABMDI Registry - ApexCert]';
const AMAZON_URL = 'https://www.amazon.com/dp/B0GZL59S95';
      ...
      <div className="flex items-start gap-3">
        ...
        <div>
          ...
          <p className="text-xs text-slate-400 leading-relaxed mb-4">
            If our ABMDI Registry book helped with your preparation, we'd truly appreciate a quick review on Amazon — it means the world to our small brand and helps other candidates find the right resource. Thank you so much!
          </p>
          <a
            href={AMAZON_URL}
            target="_blank"
      ...
      <div className="lg:grid lg:grid-cols-5 lg:gap-10">
        ...
        <div className="lg:col-span-2 mb-6 lg:mb-0">
          ...
          <p className="text-slate-400 text-sm leading-relaxed mb-6">
            How is the ABMDI Registry study portal working for you? We built this to help you pass — your honest feedback helps us make it better.
          </p>
