...
// ← Change PORTAL_PASSWORD to whatever you print in the ABMDI book
const PORTAL_PASSWORD = 'ABMDI2025';
const CREATOR_PASSWORD = 'hpJOHN2003.';
const STORAGE_KEY = 'abmdi_unlocked';
    ...
    <div className="fixed inset-0 bg-slate-950 flex items-center justify-center px-6">
      <div className="w-full max-w-sm">
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-slate-100 mb-1">ABMDI Registry</h1>
